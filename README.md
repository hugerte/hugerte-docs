...
In this repo, we want to provide docs for HugeRTE that are freely usable. The text of this docs is licensed under the MIT license, but code snippets are licensed under the MIT No Attribution license so you can quickly copy them into your project without worrying about attribution.
